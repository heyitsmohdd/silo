...
const ContactModal = ({ isOpen, onClose }: ContactModalProps) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-50 w-full max-w-md mx-4 bg-zinc-900 border border-white/10 rounded-2xl shadow-2xl animate-fade-in-scale p-4 sm:p-6">
                <button
                    onClick={onClose}
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-xs text-zinc-500 group-hover:text-zinc-400 transition-colors">Share ideas or suggestions</div>
                                </div>
                            </div>
                            <ExternalLink className="w-4 h-4 text-zinc-600 group-hover:text-zinc-400 transition-colors" />
                        </a>
